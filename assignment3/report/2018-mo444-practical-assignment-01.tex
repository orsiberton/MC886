...
Primeiro foi ralizado o clustering com as manchetes de todos os anos. Na Figura \ref{fig:inertia_all_years} temos a função de custo para os diferentes valores de K.
