...
def read_x_values_from_row(row=None):
    if row:
        x_row = np.array([[
            ...
            float(row['n_tokens_title']) * float(row['n_tokens_title']) * float(row['n_tokens_title']),
            float(row['n_tokens_content']) * float(row['n_tokens_content']) * float(row['n_tokens_content']),
            float(row['n_unique_tokens']) * float(row['n_unique_tokens']) * float(row['n_unique_tokens']),
            float(row['n_non_stop_words']) * float(row['n_non_stop_words']) * float(row['n_non_stop_words']),
            float(row['n_non_stop_unique_tokens']) * float(row['n_non_stop_unique_tokens']) * float(row['n_non_stop_unique_tokens']),
            float(row['num_hrefs']) * float(row['num_hrefs']) * float(row['num_hrefs']),
            float(row['num_self_hrefs']) * float(row['num_self_hrefs']) * float(row['num_self_hrefs']),
            float(row['num_imgs']) * float(row['num_imgs']) * float(row['num_imgs']),
            float(row['num_videos']) * float(row['num_videos']) * float(row['num_videos']),
            float(row['average_token_length']) * float(row['average_token_length']) * float(row['average_token_length']),
            float(row['num_keywords']) * float(row['num_keywords']) * float(row['num_keywords']),
            # float(row['data_channel_is_lifestyle']) + float(row['data_channel_is_entertainment']) + float(row['data_channel_is_bus']) + float(row['data_channel_is_socmed']) + float(row['data_channel_is_tech']) + float(row['data_channel_is_world']),
            ...
            float(row['kw_min_min']) * float(row['kw_min_min']) * float(row['kw_min_min']),
            float(row['kw_max_min']) * float(row['kw_max_min']) * float(row['kw_max_min']),
            float(row['kw_avg_min']) * float(row['kw_avg_min']) * float(row['kw_avg_min']),
            float(row['kw_min_max']) * float(row['kw_min_max']) * float(row['kw_min_max']),
            float(row['kw_max_max']) * float(row['kw_max_max']) * float(row['kw_max_max']),
            float(row['kw_avg_max']) * float(row['kw_avg_max']) * float(row['kw_avg_max']),
            float(row['kw_min_avg']) * float(row['kw_min_avg']) * float(row['kw_min_avg']),
            float(row['kw_max_avg']) * float(row['kw_max_avg']) * float(row['kw_max_avg']),
            float(row['kw_avg_avg']) * float(row['kw_avg_avg']) * float(row['kw_avg_avg']),
            float(row['self_reference_min_shares']) * float(row['self_reference_min_shares']) * float(row['self_reference_min_shares']),
            float(row['self_reference_max_shares']) * float(row['self_reference_max_shares']) * float(row['self_reference_max_shares']),
            float(row['self_reference_avg_sharess']) * float(row['self_reference_avg_sharess']) * float(row['self_reference_avg_sharess']),
            # float(row['weekday_is_monday']) + float(row['weekday_is_tuesday']) + float(row['weekday_is_wednesday']) + float(row['weekday_is_thursday']) + float(row['weekday_is_friday']) + float(row['weekday_is_saturday']) + float(row['weekday_is_sunday']) + float(row['is_weekend']),
            ...
            float(row['LDA_00']) * float(row['LDA_00']) * float(row['LDA_00']),
            float(row['LDA_01']) * float(row['LDA_01']) * float(row['LDA_01']),
            float(row['LDA_02']) * float(row['LDA_02']) * float(row['LDA_02']),
            float(row['LDA_03']) * float(row['LDA_03']) * float(row['LDA_03']),
            float(row['LDA_04']) * float(row['LDA_04']) * float(row['LDA_04']),
            ...
            float(row['global_subjectivity']) * float(row['global_subjectivity']) * float(row['global_subjectivity']),
            float(row['global_sentiment_polarity']) * float(row['global_sentiment_polarity']) * float(row['global_sentiment_polarity']),
            float(row['global_rate_positive_words']) * float(row['global_rate_positive_words']) * float(row['global_rate_positive_words']),
            float(row['global_rate_negative_words']) * float(row['global_rate_negative_words']) * float(row['global_rate_negative_words']),
            float(row['rate_positive_words']) * float(row['rate_positive_words']) * float(row['rate_positive_words']),
            float(row['rate_negative_words']) * float(row['rate_negative_words']) * float(row['rate_negative_words']),
            float(row['avg_positive_polarity']) * float(row['avg_positive_polarity']) * float(row['avg_positive_polarity']),
            float(row['min_positive_polarity']) * float(row['min_positive_polarity']) * float(row['min_positive_polarity']),
            float(row['max_positive_polarity']) * float(row['max_positive_polarity']) * float(row['max_positive_polarity']),
            float(row['avg_negative_polarity']) * float(row['avg_negative_polarity']) * float(row['avg_negative_polarity']),
            float(row['min_negative_polarity']) * float(row['min_negative_polarity']) * float(row['min_negative_polarity']),
            float(row['max_negative_polarity']) * float(row['max_negative_polarity']) * float(row['max_negative_polarity']),
            float(row['title_subjectivity']) * float(row['title_subjectivity']) * float(row['title_subjectivity']),
            float(row['title_sentiment_polarity']) * float(row['title_sentiment_polarity']) * float(row['title_sentiment_polarity']),
            float(row['abs_title_subjectivity']) * float(row['abs_title_subjectivity']) * float(row['abs_title_subjectivity']),
            float(row['abs_title_sentiment_polarity']) * float(row['abs_title_sentiment_polarity']) * float(row['abs_title_sentiment_polarity'])
        ]])
